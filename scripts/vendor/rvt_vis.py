# Vendored from https://github.com/EarthObservation/RVT_py (rvt/vis.py)
# Copyright ZRC SAZU and University of Ljubljana - Apache License 2.0
# (vendored 2026-08-13 because the PyPI package declares a GDAL dependency
# the functions below do not actually need: numpy + scipy only).
"""
